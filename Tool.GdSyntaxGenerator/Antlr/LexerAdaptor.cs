...
namespace Tool.GdSyntaxGenerator.Grammar {
        ...
        #pragma warning restore CA1012 // But Lexer demands it - old 
    {
        ...
        readonly FieldInfo _tokenInput = typeof(CommonToken).GetField("type", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        public override IToken NextToken() {
            ...
            if (Type == AntlrV4Tokens.ID) {
                char firstChar = _stream.GetText(Interval.Of(_tokenStartCharIndex, _tokenStartCharIndex))[0];
                if (char.IsUpper(firstChar)) {
                    Type = AntlrV4Tokens.TOKEN_REF;
                    _tokenInput.SetValue(token, AntlrV4Tokens.TOKEN_REF);
                }
                ...
                if (char.IsLower(firstChar)) {
                    ...
                    // token.Type=
                    _tokenInput.SetValue(token, AntlrV4Tokens.RULE_REF);
                }
